...
class CommittedMetadataTests(unittest.TestCase):
    def test_exact_original_metadata_and_source_qualification(self):
        ...
        self.assertEqual(release['sourceRevision'], '540968774b9aed8bafe4446ee22378b9021b3df9')
        self.assertEqual(release['sourceTree'], 'b55b19ed2d052e89810e112f57ba7da6c13d1c36')
